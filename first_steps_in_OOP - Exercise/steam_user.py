# Create a class called SteamUser. Upon initialization, it should receive a username (string) and games (list). It should also have an attribute called p
# layed_hours (0 by default). Add three methods to the class:
# -	play(game, hours)
