...
# The Task class should receive a name (string) and a due_date (str) upon initialization. A task also has two attributes: comments (empty list) and 
...
print(task.edit_comment(1000, "Don't forget laptop and notebook"))
print(task.details())
