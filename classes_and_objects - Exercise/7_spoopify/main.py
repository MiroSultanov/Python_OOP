...
# The Album class should receive a name (string) upon initialization and might receive one or more songs. It also has instance attributes: published 
#   (False by default) and songs (an empty list). It has four methods:
# -	add_song(song: Song)
