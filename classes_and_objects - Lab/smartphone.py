# Create a class called Smartphone. Upon initialization, it should receive a memory (number). It should also have 2 other instance attributes: 
#     apps (empty list by default) and is_on (False by default). Create 3 methods:
