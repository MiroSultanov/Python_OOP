...
# •	The Coffee class should have an additional private attribute – caffeine: float and its subsequent getter. It should also have the following 
#   class attributes, which should apply to all coffees made:
