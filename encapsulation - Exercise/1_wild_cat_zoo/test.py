# The Animal class is a base class for any type of animal in the zoo. It should receive four public attributes - a name (string), a gender (str), an age (int), 
...
# •	A tiger needs 45
# •	A cheetah needs 60
# The Worker class is a base class for any type of employee in the zoo. It should receive three public attributes - a name (string), an age (int), and a salary 
# (int) upon initialization.
...
# o	If you have enough budget and capacity add the animal (instance of Lion/Tiger/Cheetah) to the animals' list, reduce the budget, and 
# return "{name} the {type of animal (Lion/Tiger/Cheetah)} added to the zoo"
...
# •	hire_worker(worker)
# o	If you have not exceeded the capacity of workers in the zoo for the worker (instance of Keeper/Caretaker/Vet), add him to the workers and 
