...
# •	username: str - the username should be between 5 and 15 characters (inclusive). If it is not, raise a ValueError with the 
...
class Profile:
    ...
    def password(self, value):
        ...
        is_digit_case = [char for char in value if char.isdigit()]


        if not is_length_valid or not is_upper_case or not is_digit_case:
