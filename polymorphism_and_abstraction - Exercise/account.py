...
# •	add_transaction(amount) - if the amount is not an integer, raise ValueError with the message "please use int for amount". Otherwise, add the amount to the 
# transactions
...
# •	When you concatenate two accounts, you should return a new account with a name - string in the format "{first_owner}&{second_owner}" and starting 
# amount - the sum between their two. Both their transactions should be added to the new account.
